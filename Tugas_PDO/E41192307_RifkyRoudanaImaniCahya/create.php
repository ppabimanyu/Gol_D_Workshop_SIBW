<?php
  ...
  $nama = htmlentities($_POST['nama']);
        ...
        $query = $db->prepare("INSERT INTO `pdo`(`nim`,`nama`, `alamat`, `kelas`)
...
<body bgcolor="cyan">
<h2><p align="center">Tambahkan Data</p></h2>
<form method="post">
<table width="546" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="cyan">
  <tr>
