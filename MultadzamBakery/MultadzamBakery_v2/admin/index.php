...
$jumlahData = count(query("SELECT * FROM checkout"));
$jumlahHalaman = ceil($jumlahData / $jumlahDataPerHalaman);
$halamanAktif = (isset($_GET["halaman"])) ? $_GET["halaman"] : 1;
$awalData = ($jumlahDataPerHalaman * $halamanAktif) - $jumlahDataPerHalaman;

$details = query("SELECT * FROM checkout LIMIT $awalData, $jumlahDataPerHalaman");
												...
												if ($detail['status'] === "Due") : ?>
													...
													<div class="btn-group">
														...
														<div class="dropdown-menu">
															<a class="dropdown-item" href="detail_checkout.php?id=<?= $detail['id_checkout']; ?>"><span class="fas fa-eye mr-2"></span>View Details</a>
															<a class="dropdown-item text-warning" href="status_proses.php?id=<?= $detail['id_checkout']; ?>&status=1"><span class="fas fa-edit mr-2"></span>Proses</a>
															<a class="dropdown-item text-success" href="status_proses.php?id=<?= $detail['id_checkout']; ?>&status=2"><span class="fas fa-edit mr-2"></span>Finish</a>
															<a class="dropdown-item text-danger" href="status_proses.php?id=<?= $detail['id_checkout']; ?>&status=3"><span class="fas fa-edit mr-2"></span>Cencel</a>
														</div>
													</div>
													</td>
											</tr>
