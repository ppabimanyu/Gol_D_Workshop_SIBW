...
<body>
    ...
    <div class="container" style=" margin-top: 100px; width:66%; background-color:white; margin-left:17%">
        <div class="mx-auto" style="text-align: center; font-family: 'Cormorant Upright', serif; font-size: 22px;">About Us</div><br>
        <hr>
            ...
            <div class="row">
                ...
                <div class=" col-xl-6">
                    ...
                    <p style="font-size: 18px; text-indent: 60px;">Multadzam Bakery adalah toko roti berdomisili jember yang didirikan tahun 2020. Multadzam Bakery adalah toko roti yang menjual aneka macam
                        roti homemade yang bercita rasa tinggi dengan harga yang terjangkau. Pendirinya sendiri adalah ibu vivin. Sudah banyak orderan masuk semenjak
                        Multadzam Bakery di dirikan.</p>
                    <p style="font-size: 18px; text-indent: 60px;">Kami sadar bahwa perkembangan Multadzam Bakery tidak lepas dari dukungan para pelanggan Multadzam Bakery. Hingga saat ini, mereka terus berhubungan baik dengan pelanggan-pelanggan lama dan berusaha mengenal pelanggan barunya dengan lebih baik.

                        Setiap kritik dan saran dari pelanggan ditanggapi dengan cepat dan solutif. Kami sadar bahwa kritik dan saran pelanggan sangat berarti bagi Multadzam Bakery agar dapat melayani pelanggannya dengan lebih baik.

                        Multadzam Bakery terus berusaha untuk meningkatkan kualitas produk dan layanan untuk dapat meningkatkan kepuasan setiap pelanggannya.
                    </p>
                </div>
            </div>
        </div>
