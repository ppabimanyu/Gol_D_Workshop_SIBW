    ...
    <div class="container" style=" margin-top: 100px; width:66%; background-color:white; margin-left:17%">
        ...
        <?php foreach ($fms as $fm) : ?>
            <div class="container m-5">
                <div class="row">
                    <div class="col-xl-6" style="min-height: 400px; background-color: white;"> <a href=""><img style=" width: 475px; border-radius: 20px;" src="img/foto_produk/<?= $fm['gambar_fm']; ?>" alt=""></a></div>
                    <div class="col-xl-6">
