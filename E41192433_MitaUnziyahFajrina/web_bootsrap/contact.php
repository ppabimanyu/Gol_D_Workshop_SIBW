...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-grey-800">Contact Us</h1>
</div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <input type="text" class="form-control form-control-user" id="name"  name="name" placeholder="Name Anda" required>
                </div>
                <div class="form-group">
                ...
                if ($name){
                    echo "<br><br><strong>Name:</strong> {$name} <br>";
                }
